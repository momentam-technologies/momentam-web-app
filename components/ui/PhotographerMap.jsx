...
const PhotographerMap = ({
  ...
  return (
    <motion.div
      ...
      className={`bg-white dark:bg-neutral-800 rounded-xl shadow-lg overflow-hidden ${isExpanded ? "h-full" : "h-[536px]"
        }`}
    >
      {/* Header section */}
                    ...
                    <div className="p-2">
                      ...
                      <div className="space-y-1 text-sm">
                        ...
                        <p className="text-gray-600">
                          {addresses[photographer.$id] || "Loading address..."}
                        </p>
                      </div>
                    </div>
                  </Popup>
