...
import { IconX, IconUser, IconMail, IconPhone, IconCalendar, IconClock, IconBookmark, IconStar, IconMapPin, IconClock as IconHistory, IconPhoto } from '@tabler/icons-react';
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[400px]">
            ...
            >
              ...
              <InfoItem icon={IconCalendar} label="Joined" value={userDetails.createdAt ? formatDate(userDetails.createdAt) : 'Unknown'} />
