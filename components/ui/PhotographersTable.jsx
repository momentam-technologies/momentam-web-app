...
const PhotographersTable = ({ photographers, onViewPhotographer, onEditPhotographer, onDeletePhotographer, selectedPhotographers, onSelectPhotographer, onSelectAll, isLoading }) => {
  return (
        ...
        <tbody className="bg-white dark:bg-neutral-800 divide-y divide-gray-200 dark:divide-gray-700">
          {photographers.map((photographer) => (
            ...
            >
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${photographer.verified
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                {photographer.lastLogin ? safeFormatDate(photographer.lastLogin, "PPp") : "Never"}
              </td>
